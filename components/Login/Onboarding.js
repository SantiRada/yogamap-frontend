        ...
        <View style={styles.container}>
            {
                ...
                <View style={styles.space}>
                    <Image source={{ uri: "http://192.168.100.2/API_Yogamap/assets/error404.png" }} style={styles.image} />
                    ...
                    <View style={styles.doubleButton}>
                        <Pressable style={[ styles.btn, { backgroundColor: '#ffffff25' } ]} onPress={ () => { navigation.navigate('TabGroup') } }>
